...
import AllSavingsACPrint from './printAllAccount';
import Api from '../../api/api';
import SnakBar from '../../consts/message';

export default function AllSavingsAccountInfo() {
        ...
        <Container component={Paper} maxWidth="false" style={{ padding: 0 }}>
            <Toolbar  style={{ display:'flex', justifyContent: 'space-between' ,marginBottom:5}}>
                <div style={{ display: 'flex', alignItems: 'center' }}>
                    ...
                    <Typography variant='h6' style={{fontWeight:'bold'}}>All Savings Accounts</Typography>
                </div>
                    ...
                    <TableBody>
                        {
                            data.map((item, index) =>
                                <TableRow key={index}>
                                    ...
                                    <TableCell>{item.sav_no}</TableCell>
            ...
            <PDFExport forcePageBreak='.keep' paperSize="LEGAL" margin={{ top: 5, right: 5, bottom: 5, left: 60 }} fileName='all_sav_accounts.pdf' landscape ref={pdfExportComponent}>
                <AllSavingsACPrint data={sliceData} />
            </PDFExport>
            </div>
