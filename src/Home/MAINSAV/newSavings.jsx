...
import {InputBase,Button, LinearProgress, Toolbar, Typography} from '@material-ui/core'
...
const handleEdit = (item)=>{
  history.push('/Home/SavMainHome/ProfileModify',{data : item})
}
          ...
          return (
            <TableRow hover role="checkbox" tabIndex={-1} key={row.acno}>
              ...
              <TableCell style={{padding: 0}} >
                ...
                <Link to={{ pathname: '/Home/SavMainHome/CreateSavings', query:  row.acno  }} style={{ textDecoration: 'none' }}>
