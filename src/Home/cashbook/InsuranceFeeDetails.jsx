...
export default function InsuranceFeeDetails() {
        ...
        <Container maxWidth="xxl" style={{ minHeight: '75vh' }}>
            ...
            <Paper style={{ marginTop: '20px', marginBottom: '20px' }}>
                <Toolbar component={Paper} style={{ display: 'flex', }}>
                    ...
                    <Typography variant='h5' style={{ textAlign: 'center' }}>Insurance Fees Details</Typography>
                </Toolbar>
                <TableContainer >
                    <Table>
                        <TableHead>
                            <TableRow>
                                ...
                                <TableCell style={{ fontWeight: 'bold' }}>Insurance Amount</TableCell>
                        ...
                        <TableBody>
                            {data.slice(startIndex, endIndex).map((item, index) => (
                                <TableRow key={index}>
                                    ...
                                    <TableCell >Rs.{item.insrnce}</TableCell>
