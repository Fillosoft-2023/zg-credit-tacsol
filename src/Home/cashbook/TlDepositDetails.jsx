...
export default function TlDepositDetails() {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch(Api + 'TaTransDetails', {
                method: 'POST',
                body: JSON.stringify({
                    from: from,
                    to: to,
        ...
        <Container maxWidth="xxl" style={{ minHeight: '75vh' }}>
            ...
            <Paper style={{ marginTop: '20px', marginBottom: '20px' }}>
                <Toolbar component={Paper} style={{ display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <Typography variant='h5' style={{ textAlign: 'center' }}>TL Deposit Fees Details</Typography>
                    <div></div>
                </Toolbar>
                <TableContainer >
                    <Table>
                        <TableHead>
                            <TableRow>
                                ...
                                <TableCell style={{ fontWeight: 'bold' }}>Account Amount</TableCell>
                                <TableCell style={{ fontWeight: 'bold' }}>Deposit Amount</TableCell>
                        ...
                        <TableBody>
                            {data.slice(startIndex, endIndex).map((item, index) => (
                                <TableRow key={index}>
                                    ...
                                    <TableCell>{item.ta_amt}</TableCell>
