...
export default function ProcessingFeesDetails() {
        ...
        <Container maxWidth="xxl" style={{ minHeight: '75vh' }}>
            ...
            <Paper style={{ marginTop: '20px', marginBottom: '20px' }}>
                <Toolbar component={Paper} style={{ display: 'flex', }}>
                    ...
                    <Typography variant='h5' style={{ textAlign: 'center' }}>Processing Fees Details</Typography>
                </Toolbar>
                <TableContainer >
                    <Table>
                        <TableHead>
                            <TableRow>
                                ...
                                <TableCell style={{ fontWeight: 'bold' }}>Processing Amount</TableCell>
                        ...
                        <TableBody>
                            {data.slice(startIndex, endIndex).map((item, index) => (
                                <TableRow key={index}>
                                    ...
                                    <TableCell >Rs.{item.pros_chrg}</TableCell>
