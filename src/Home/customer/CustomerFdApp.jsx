...
export default function CustomerFdApp(params) {
    ...
    return (
        <Container component={Paper} maxWidth="false" style={{ padding: 0, minHeight: '85vh' }}>
            <Toolbar component={Paper} variant='contained' style={{ justifyContent: 'space-between' }}>
                ...
                <Typography variant="h6" style={{ fontWeight: 'bold' }}>Customer Fixed Deposit Applications</Typography>
            ...
            <TableContainer component={Paper}>
                <Table>
                    <TableHead style={{ backgroundColor: '#888888' }}>
                        ...
                        <TableCell style={{ fontWeight: 'bold', color: 'white' }}>FD Type</TableCell>
                        <TableCell style={{ fontWeight: 'bold', color: 'white' }}>Dep Amount</TableCell>
                        <TableCell style={{ fontWeight: 'bold', color: 'white' }}>FD Tenure</TableCell>
                            ...
                            data
                                ...
                                .map((item, index) => (
                                    <TableRow key={index}>
                                        ...
                                        <TableCell>{item.fd_type}</TableCell>
                                        ...
                                        <TableCell style={{ textAlign: 'center' }}>
                                            <Button
                                                onClick={() => onApproved(item.id)}
                                                variant="contained"
                                                size="small"
                                                style={{ backgroundColor: '#22B33A', fontWeight: 'bold', color: 'white', borderRadius: 15 }}
                                            >
                                                Approve
                                            </Button>
                                        </TableCell>
                                        <TableCell style={{ textAlign: 'center' }}>
                                            <Button
                                                ...
                                                variant="contained"
                                                size="small"
                                                style={{ backgroundColor: '#F60002', fontWeight: 'bold', color: 'white', borderRadius: 15 }}
                                            >
                                                Reject
                                            </Button>
                                        </TableCell>
                                        <TableCell style={{ textAlign: 'center' }}>
                                            <Link to={{ pathname: '/Home/FdHome/CreateFd', query: item.ac_no }}
