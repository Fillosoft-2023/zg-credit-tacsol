...
export default function CustomerRdApp(params) {
    ...
    return (
        <Container component={Paper} maxWidth="false" style={{ padding: 0, minHeight: '85vh' }}>
            <Toolbar component={Paper} variant='contained' style={{ justifyContent: 'space-between' }}>
                ...
                <Typography variant="h6" style={{ fontWeight: 'bold' }}>Customer Recurring Deposit Applications</Typography>
                            ...
                            data
                                ...
                                .map((item, index) => (
                                    <TableRow key={index}>
                                        ...
                                        <TableCell style={{ textAlign: 'center' }}>
                                            <Link to={{ pathname: '/Home/SavHome/CreateSav', query: item.ac_no }}
