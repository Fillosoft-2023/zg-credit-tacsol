import { Container, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Toolbar, Button, IconButton, CircularProgress, LinearProgress, Dialog, DialogContent, Box, Tooltip } from "@material-ui/core";
...
export default function CustomerSavingsPayments(props) {
    ...
    return (
        <Container maxWidth="false" style={{ padding: 0 }} component={Paper}>
            <Toolbar component={Paper} style={{ padding: 5, marginBottom: 5, justifyContent: 'space-between' }}>
                ...
                <h2 style={{ color: '#303F9F' }}>Savings Payments Details</h2>
