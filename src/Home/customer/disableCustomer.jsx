...
export default function DisableCustomer(props) {
  ...
  return (
    <div>
      ...
      >
        <DialogTitle id="alert-dialog-slide-title">{"Are you sure to change customer status"}</DialogTitle>
        <DialogContent>
