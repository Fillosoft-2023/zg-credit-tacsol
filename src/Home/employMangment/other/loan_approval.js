...
export default function NewLoanApproval(params) {
    ...
    return (
        ...
        <Toolbar component={Paper} variant='outlined' style={{justifyContent : 'space-between'}}>
            <Typography>Loan Request By Agent</Typography>
                ...
                <TableBody>
                {
                    data.map((item,index)=>
                        <TableRow key={index}>
                            ...
                            <TableCell>
                                <Button onClick={()=>onApproved(item.id)} variant="contained" size="small" color="primary">Approve</Button>
                            </TableCell>
                        </TableRow>
                    )
                }
