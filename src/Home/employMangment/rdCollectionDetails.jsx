...
import MyDocument from '../../pdf/juornal/rdPrintDetails';
import { useHistory } from 'react-router-dom/cjs/react-router-dom.min';


function RdCollectionDetails() {
    ...
    React.useEffect(() => {
        if (massg) {
            fetch(Api + 'agentRdCollectionDetails', {
                method: 'POST',
                body: JSON.stringify({
                    ...searchDates,
                    agent_id: agentId,
            ...
            <Toolbar component={Paper} style={{ display: 'flex', justifyContent: 'space-between', padding: '5px' }}>
                <Typography style={{ display: 'flex',justifyContent:'left'}}>
                    ...
                    <Typography variant='h6' style={{ fontWeight: 'bold',marginLeft:5 }}>
                        RD Collection Details Of Agent ID: {agentId}
                        </Typography>
                </Typography>
...
export default RdCollectionDetails;
