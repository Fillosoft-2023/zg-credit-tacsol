...
const conformiseCalc = (id)=>{
    if(data.mt_stus != 'matured'){
        let today = new Date();
        today = today.toLocaleDateString("en-CA");
        setLoading(true)
                fetch(Api+'ta_maturity',{
                  method : 'POST',
...
const loanInfo = ()=> {
    ...
    return (
        <Table className={style.table}>
            <TableBody>
                <TableRow>
                    <TableCell component="th" scope="row">TL NO</TableCell>
                ...
                <TableRow>
                    ...
                    <TableCell>{DateHandler(data.mt_dt)}</TableCell>
                </TableRow>
                <TableRow>
                ...
                <TableRow>
                    <TableCell >TL Amount</TableCell>
                    <TableCell>{data.ta_amt}</TableCell>
                </TableRow>
                <TableRow>
                ...
                <TableRow>
                    ...
                    <TableCell>Rs.{data.int_amt}</TableCell>
                </TableRow>
                <TableRow>
                ...
                <Grid item xs={12} sm={6}>
                    <Paper className={style.profdet}>
                       
                            {
                                ...
                                <div>
                                <div style={{width: '100%', flexDirection:'row', display: 'flex',alignItems: 'center'}}>
                                <Typography style={{padding: 10}}>TL Information</Typography>
