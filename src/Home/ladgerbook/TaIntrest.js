...
import MyDocument from './../../pdf/juornal/taInterestRecord'
import GetAppIcon from '@material-ui/icons/GetApp';
import PrintIcon from '@material-ui/icons/Print';
import DateHandler from '../../consts/date_format';
import Api from '../../api/api';
export default function TaInterest(){
    ...
    return (
        ...
        <Typography style={{margin: 5,marginRight: 20,textAlign: 'center'}}>TL Interest records</Typography>
        <TextField
                type="month"
                variant="outlined"
                size="small"
         ...
         {
                ready ? (   
                    <PDFDownloadLink document={<MyDocument callback={send} DateDiffer={date} />} fileName={filename+"TAInterestRecord.pdf"}>
                                ...
                                Data.map((item,index)=> {
                                    ...
                                    return (
                                        <TableRow key={index}>
                                            ...
                                            <TableCell>{item.ac_no} / {item.tl_acno}</TableCell>
