...
import MyDocument from './../../pdf/juornal/bankDeposite'
...
export default function BankDeposit(){
    ...
    return (
        ...
        <Typography style={{margin: 5,marginRight: 20,textAlign: 'center'}}>Bank Deposite</Typography>
            {/* <TextField
                type="date"
                variant="outlined"
                size="small"
            ...
            <Button onClick={onSearch} style={{marginLeft: 10}} size="small" color='primary' variant='contained'>
             ...
             {
                ready ? (   
                    <PDFDownloadLink document={<MyDocument callback={send} DateDiffer={date} />} fileName={filename+"BankDepositRecord.pdf"}>
