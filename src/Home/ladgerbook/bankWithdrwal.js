...
import MyDocument from './../../pdf/juornal/bankWithdrwal'
import GetAppIcon from '@material-ui/icons/GetApp';
import PrintIcon from '@material-ui/icons/Print';
import DateHandler from '../../consts/date_format';
import Api from '../../api/api';
export default function BankWithdrwal(){
    ...
    return (
        ...
        <Typography style={{margin: 5,marginRight: 20,textAlign: 'center'}}>Bank Withdrawal</Typography>
            {/* <TextField
                type="date"
                variant="outlined"
                size="small"
            ...
            <Button onClick={onSearch} style={{marginLeft: 10}} size="small" color='primary' variant='contained'>
             ...
             {
                ready ? (   
                    <PDFDownloadLink document={<MyDocument callback={send} DateDiffer={date} />} fileName={filename+"BankWithdrwal.pdf"}>
