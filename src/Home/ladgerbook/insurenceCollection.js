...
export default function Insurence(){
    ...
    return (
        ...
        <Typography style={{margin: 5,marginRight: 20,textAlign: 'center'}}>Insurence collection Records</Typography>
            <TextField
                type="date"
                variant="outlined"
                size="small"
            ...
            />
             {
                ready ? (   
                    <PDFDownloadLink document={<MyDocument callback={send} DateDiffer={date} />} fileName={filename+"InsurencecollectionRecord.pdf"}>
                                ...
                                Data.map((item,index)=> {
                                    ...
                                    return (
                                        <TableRow key={index}>
                                            ...
                                            <TableCell>Insurence collection from {item.ac_no}</TableCell>
