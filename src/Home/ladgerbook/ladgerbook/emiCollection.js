...
export default function EmiCollect(){
    ...
    return (
        ...
        <Typography style={{margin: 5,marginRight: 20,textAlign: 'center'}}>Emi collection records</Typography>
            <TextField
                type="date"
                variant="outlined"
                size="small"
            ...
            {
                ready ? (   
                    <PDFDownloadLink document={<MyDocument callback={send} />} fileName={filename+"EmicollectionRecord.pdf"}>
                                ...
                                Data.map((item,index)=> {
                                    ...
                                    return (
                                        <TableRow key={index}>
                                            ...
                                            <TableCell>EMI from {item.ac_no}</TableCell>
                                            <TableCell style={{color: '#42f548'}}>{item.ttl}</TableCell>
