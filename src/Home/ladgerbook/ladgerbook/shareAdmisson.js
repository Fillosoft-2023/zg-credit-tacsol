...
export default function ShareAdm(){
    ...
    return (
        ...
        <Typography style={{margin: 5,marginRight: 20,textAlign: 'center'}}>Share Addmisson Records</Typography>
            <TextField
                type="date"
                variant="outlined"
                size="small"
            ...
            {
                ready ? (   
                    <PDFDownloadLink document={<MyDocument callback={send} />} fileName={filename+"ShareAdmissioncollectionRecord.pdf"}>
