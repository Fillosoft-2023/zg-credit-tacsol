...
export default function TaCollection(){
    ...
    return (
        ...
        <Typography style={{margin: 5,marginRight: 20,textAlign: 'center'}}>Ta collection records</Typography>
            <TextField
                type="date"
                variant="outlined"
                size="small"
            ...
            {
                ready ? (   
                    <PDFDownloadLink document={<MyDocument callback={send} />} fileName={filename+"TAcollectionRecord.pdf"}>
                                ...
                                Data.map((item,index)=> {
                                    ...
                                    return (
                                        <TableRow key={index}>
                                            ...
                                            <TableCell style={{color: '#42f548'}}>{item.ta_amt}</TableCell>
