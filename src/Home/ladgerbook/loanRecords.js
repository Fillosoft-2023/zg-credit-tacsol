...
export default function LoanRecords(){
    ...
    return (
        ...
        <Paper className={classes.dateBar}>
            <div>
            <Typography style={{margin: 5,fontWeight:'bold'}}>Loan Issued to member</Typography>
                                ...
                                filterd.map((item,index)=> {
                                    ...
                                    return (
                                        <TableRow key={index}>
                                            ...
                                            <TableCell style={{color: 'red'}}>Deposit</TableCell>
                                            <TableCell style={{color: 'red'}}>{sum.toFixed(2)}</TableCell>
                                        </TableRow>
                                    )
                                })
                            }
