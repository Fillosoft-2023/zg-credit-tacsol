...
import MyDocument from './../../pdf/juornal/propertybuyRecord'
...
export default function PropertyBuy(){
    ...
    return (
        ...
        <Typography style={{margin: 5,marginRight: 20,textAlign: 'center'}}>Property Buy Records</Typography>
            <TextField
                type="date"
                variant="outlined"
                size="small"
            ...
            {
                ready ? (   
                    <PDFDownloadLink document={<MyDocument callback={send} DateDiffer={date} />} fileName={filename+"PropertybuyRecord.pdf"}>
