...
import MyDocument from './../../pdf/juornal/savingsInterest'
import GetAppIcon from '@material-ui/icons/GetApp';
import PrintIcon from '@material-ui/icons/Print';
import DateHandler from '../../consts/date_format';
import Api from '../../api/api';
export default function SavRecordInt(){
    ...
    const onSearch = ()=>{
        // console.log(date)
        fetch(Api+'ladgerBookSavingsInt',{
            method : 'POST',
    ...
    return (
        ...
        <TextField
            ...
            <Button onClick={onSearch} style={{marginLeft: 10}} size="small" color='primary' variant='contained'>
             ...
             {
                ready ? (   
                    <PDFDownloadLink document={<MyDocument callback={send} DateDiffer={date} />} fileName={filename+"savingsInterest.pdf"}>
                                ...
                                return (
                                    ...
                                    { item.int != 0 ? (
                                        ...
                                        <TableRow>
                                            ...
                                            <TableCell>RD Withdrwal {item.ac_no}</TableCell>
                                            <TableCell style={{color: 'red'}}>{item.int}</TableCell>
