...
export default function SavRecordWith(){
    ...
    const onSearch = ()=>{
        // console.log(date)
        fetch(Api+'ladgerBookSavingsWithdrwal',{
            method : 'POST',
    ...
    return (
        ...
        <Typography style={{margin: 5,marginRight: 20,textAlign: 'center'}}>RD Withdrawal Records</Typography>
        <TextField
                type="month"
                variant="outlined"
                size="small"
