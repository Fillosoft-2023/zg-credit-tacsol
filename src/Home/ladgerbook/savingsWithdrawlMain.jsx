...
import MyDocument from './../../pdf/juornal/savingsWithdrwal'
import GetAppIcon from '@material-ui/icons/GetApp';
import PrintIcon from '@material-ui/icons/Print';
import DateHandler from '../../consts/date_format';
import Api from '../../api/api';
export default function SavRecordWithMain(){
    ...
    const onSearch = ()=>{
        // console.log(date)
        fetch(Api+'ladgerBookSavingsWithdrwalMain',{
            method : 'POST',
    ...
    return (
        ...
        <Typography style={{margin: 5,marginRight: 20,textAlign: 'center'}}>Savings Withdrawal Records</Typography>
        <TextField
                type="month"
                variant="outlined"
                size="small"
            ...
            <Button onClick={onSearch} style={{marginLeft: 10}} size="small" color='primary' variant='contained'>
             ...
             {
                ready ? (   
                    <PDFDownloadLink document={<MyDocument callback={send} DateDiffer={date} />} fileName={filename+"savingsWith.pdf"}>
