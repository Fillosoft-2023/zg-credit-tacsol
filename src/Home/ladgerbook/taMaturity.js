...
export default function TaMaturity(){
    ...
    return (
        ...
        <Typography style={{margin: 5,marginRight: 20,textAlign: 'center'}}>TL Withdrawal records</Typography>
        <TextField
                type="month"
                variant="outlined"
                size="small"
         ...
         {
                ready ? (   
                    <PDFDownloadLink document={<MyDocument callback={send} DateDiffer={date} />} fileName={filename+"TAmaturity Record.pdf"}>
