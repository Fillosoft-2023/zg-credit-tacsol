...
export default function DeleteLoan(props) {
  ...
  return (
    <div>
      ...
      <Button color="secondary" style={{marginLeft: 5}} size='small' variant="contained" onClick={handleClickOpen}>
        Delete
      </Button>
      <Dialog
        open={open}
