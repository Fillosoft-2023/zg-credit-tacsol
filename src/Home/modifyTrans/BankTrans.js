...
export default function BankTrans(props){
    ...
    return (
      <Container>
        ...
        <Typography style={{margin: 5,marginRight: 20,textAlign: 'center'}}>Bank transaction</Typography>
            <TextField
                type="date"
                variant="outlined"
                size="small"
                        ...
                        Data.map((item,index)=> {
                            return (
                                <TableRow>
                                    ...
                                    <TableCell>{item.trans_type === 'interst' ? 'interest' : item.trans_type}</TableCell>
