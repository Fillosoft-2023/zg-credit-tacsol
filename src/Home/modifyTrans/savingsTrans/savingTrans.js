...
export default function SavTrans(props) {
  ...
  return (
    <Container component={Paper} style={{ padding: 5, margin: 0 }}>
      <Toolbar component={Paper} style={{ display: 'flex', justifyContent: 'space-between',marginBottom:5 }}>
        <div>
          <Typography variant='h6' style={{fontWeight:'bold'}}>RD A/C Transaction</Typography>
        </div>
        <div>
          <TextField
            type="date"
