...
export default function ShareTrans(props){
    ...
    return (
      <Container>
        ...
        <Typography style={{margin: 5,marginRight: 20,textAlign: 'center'}}>Share transaction</Typography>
            <TextField
                type="date"
                variant="outlined"
                size="small"
            ...
            <Table>
                <TableHead>
                    <TableRow>
                        ...
                        <TableCell>Withdrwal</TableCell>
                        <TableCell>Devidend</TableCell>
                        <TableCell>Devidend withdrwal</TableCell>
