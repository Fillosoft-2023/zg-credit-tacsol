...
export default function TaTrans(props){
    ...
    return (
      <Container>
        ...
        <Typography style={{margin: 5,marginRight: 20,textAlign: 'center'}}>Tl transaction</Typography>
            <TextField
                type="date"
                variant="outlined"
                size="small"
