...
export default function AllSavingsPrint(props){
    ...
    data.map((item,index)=>{
        ...
        <div className={index > 0 ? 'keep' : ''} key={index}>
            ...
            <Typography style={{margin: 0,textAlign: 'right',fontSize : 10}}>Page {index+1}/{data.length}</Typography>
                ...
                <Typography style={{fontSize : 12}}>All RD Account Details</Typography>
            </div>
            <table className='table'>
                <tr >
                    ...
                    <th id="th" className='th_tot_emi'>Frequency</th>
