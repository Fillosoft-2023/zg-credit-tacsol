...
export default function SavModify(props) {
    ...
    return (
        <Container style={{ padding: 0 }} >
            <Toolbar component={Paper} style={{ display: 'flex', marginBottom: 5 }}>
                ...
                <Typography variant='h6' style={{ fontWeight: 'bold' }}>Modify RD A/C Details</Typography>
            </Toolbar>
            ...
            <Dialog open={openModal} style={{ padding: 50, border: '2px solid #303F9F' }}>
                ...
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    ...
                    <Button onClick={() => history.push('/Home/SavHome/')}>
                        <Close />
                    </Button>
                </div>
                <DialogContent>
