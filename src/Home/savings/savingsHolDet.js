...
import DeleteSav from './delSav'
import DateHandler from '../../consts/date_format'
import SnakBar from '../../consts/message'
import Api from '../../api/api'
import { ArrowBack } from '@material-ui/icons'
export default function SavHolDet(props) {
    ...
    const routeToSav = () => {
        history.push('/Home/SavHome/SavModify', { data: data })
    }
    ...
    const loanInfo = () => {
        ...
        return (
            <Table className={style.table}>
                <TableBody>
                    {/* <TableRow>
                        <TableCell component="th" scope="row">RD NO</TableCell>
                    ...
                    {/* <TableRow>
                        <TableCell component="th" scope="row">RD ac no</TableCell>
                        <TableCell>{data.sv_acno}</TableCell>
                    </TableRow> */}
                    <TableRow>
                        <TableCell >Open Date</TableCell>
                    ...
                    <TableRow>
                        <TableCell >Insurance Fee</TableCell>
                        <TableCell>
                            Rs.{data.insur}
                        </TableCell>
                    </TableRow>
                    ...
                    <Paper className={style.profdet}>

                        {
                            imgDisplay === 'set' ? (
                                ...
                                <div style={{ height: '100%', width: '100%' }}>
                                    <Button onClick={() => setImgDisplay('a')}>Return to RD A/C information</Button>
                                    <div style={{ alignItems: 'center', justifyContent: 'center', height: '90%', width: '100%', display: 'flex' }}>
