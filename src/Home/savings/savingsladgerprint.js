...
export default class SavingsLadgerPrint extends React.Component{
                ...
                <table className="table-ladger">
                    ...
                    this.props.data.map((item,index)=>
                    {
                        ...
                        return (<tr key={index}>
                            ...
                            <td className="td-ladger">{item.dep}</td>
                            <td className="td-ladger">{item.int}</td>
                            <td className="td-ladger">{item.with}</td>
