...
export default function GovtMaster() {
    ...
    if(pass != ''){
      setLoading(true)
        ...
        .then(res=>{
          setLoading(false)
          if(res.code === 200){
            history.push('GovtSettings',{authentication : true})
          }else{
            setMassg({
              open : true,
              severity : 'error',
  ...
  return (
    <Container component={Paper} elevation={3} maxWidth="false" style={{height:'84vh'}}>
      <Toolbar component={Paper} style={{display:'flex',justifyContent:'center'}}>
        <Typography variant='h6' style={{fontWeight:'bold'}}>
          Goverment Account Settings
        </Typography>
      </Toolbar>
