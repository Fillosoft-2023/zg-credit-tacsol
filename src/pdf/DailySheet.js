...
import json from './../appInfo.json'
  ...
  const columns = [
      "AC_NO","DATE","EMI AMOUNT","OVERDUE AMOUNT","RECEIVEABLE AMOUNT","FINE","RECIVED AMOUNT","OVERDUE"
  ]
                        ...
                        
                         {
                            Rows.map((item,index) => {
                                return (
                                    ...
                                    <View style={styles.TableCol}>
                                        <Text style={styles.secText}>{item.dte}</Text>
                                    </View>
                                    <View style={styles.TableCol}>
                                        <Text style={styles.secText}>{item.emi_amnt}</Text>
                                    </View>
                                    <View style={styles.TableCol}>
                                        <Text style={styles.secText}>{item.ttl_due}</Text>
                                    </View>
                                    <View style={styles.TableCol}>
                                        <Text style={styles.secText}>{Number(Number(item.emi_amnt) + Number(item.ttl_due)).toFixed(2)}</Text>
                                    </View>
                                    <View style={styles.TableCol}>
