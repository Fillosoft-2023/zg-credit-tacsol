        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.head}>
                    ...
                    <Text style={{fontSize: 10,textAlign: 'center'}}>Loan Issue Account</Text>
                    </View>
                </View>
                        ...
                        <View style={styles.container}>
                           <View style={styles.Table}>
                                <View style={styles.TableRow}>
                                    ...
                                    <View style={styles.TableColumn}><Text>Loan type</Text></View>
...

                                {
                                    rows.map((item,index)=>{
                                        ...
                                        return (
                                            <View style={styles.TableRow}>
                                                <View style={styles.TableColumn}><Text>{item.opn_dte}</Text></View>
                                                <View style={styles.TableColumn}><Text>Loan to {item.ac_no}</Text></View>
                                                <View style={styles.TableColumn}><Text>{item.ln_tpe}</Text></View>
                                                <View style={styles.TableColumn}><Text>{item.ln_amnt}</Text></View>
