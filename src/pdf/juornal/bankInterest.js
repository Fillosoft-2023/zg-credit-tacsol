        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.head}>
                    ...
                    <Text style={{fontSize: 10,textAlign: 'center'}}>Bank Interest Receipt Record</Text>
                    </View>
                </View>
                        ...
                        <View style={styles.container}>
                           <View style={styles.Table}>
                                <View style={styles.TableRow}>
                                    ...
                                    <View style={styles.TableColumnLg}><Text>Detail</Text></View>
                                    ...
                                    rows.map((item,index)=>{
                                        ...
                                        return (
                                            <View>
                                            {
                                                ...
                                                <View style={styles.TableColumnLg}><Text> Interest collection from {item.ac_no}</Text></View>
