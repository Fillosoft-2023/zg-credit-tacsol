        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.head}>
                    ...
                    <Text style={{fontSize: 10,textAlign: 'center'}}>Loan capital receipt Account</Text>
                    </View>
                </View>
                                    ...
                                    rows.map((item,index)=>{
                                        ...
                                        return (
                                            <View style={styles.TableRow}>
                                                ...
                                                <View style={styles.TableColumnLg}><Text>From {item.ac_no}</Text></View>
                                                <View style={styles.TableColumn}><Text>{Number(item.prncpl).toFixed(2)}</Text></View>
