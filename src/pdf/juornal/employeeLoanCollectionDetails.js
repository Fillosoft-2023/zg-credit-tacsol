                ...
                <View>
                    <View style={styles.head}>
                        ...
                        <View style={styles.headDet}>
                            <Text style={{ fontSize: 10, textAlign: 'center' }}>Employee Loan Collection Details</Text>
                        </View>
                    </View>
                                ...
                                {rows.map((item, index) => {
                                    ...
                                    return (
                                        <View style={styles.TableRow} key={index}>
                                            ...
                                            <View style={{ width: '14%', fontSize: 10 }}><Text>{item.ln_id}</Text></View>
                                            <View style={{ width: '14%', fontSize: 10 }}><Text>{item.recived_date}</Text></View>
                                            <View style={{ width: '14%', fontSize: 10 }}><Text>Rs.{item.ttl}</Text></View>
