        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.head}>
                    ...
                    <Text style={{fontSize: 10,textAlign: 'center'}}>Fine Collection Account</Text>
                    </View>
                </View>
                        ...
                        <View style={styles.container}>
                           <View style={styles.Table}>
                                <View style={styles.TableRow}>
                                    <View style={styles.TableColumn}><Text>Sl No.</Text></View>
...

                                {
                                    rows.map((item,index)=>{
                                        ...
                                        return (
                                            <View style={styles.TableRow}>
                                                <View style={styles.TableColumn}><Text>{index+1}</Text></View>
                                                <View style={styles.TableColumn}><Text>{item.date}</Text></View>
                                                <View style={styles.TableColumnLg}><Text>Fine collection from {item.ac_no}</Text></View>
