        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.head}>
                    ...
                    <Text style={{fontSize: 10,textAlign: 'center'}}>Interest Collection Account</Text>
                    </View>
                </View>
                           ...
                           <View style={styles.Table}>
...

                                {
                                    rows.map((item,index)=>{
                                        ...
                                        return (
                                            <View style={styles.TableRow}>
                                                <View style={styles.TableColumn}><Text>{item.recived_date}</Text></View>
                                                <View style={styles.TableColumnLg}><Text>{item.ln_type === 'other' ? 'personal'  : item.ln_type === 'squred' ? 'secured' :  item.ln_type}</Text></View>
                                                <View style={styles.TableColumn}><Text>{item.interest}</Text></View>
                                                <View style={styles.TableColumn}><Text>Deposit</Text></View>
                                                <View style={styles.TableColumn}><Text>{sum.toFixed(2)}</Text></View>
                                            </View>
                                        )
                                    })
                                }
