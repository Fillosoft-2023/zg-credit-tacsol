        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.head}>
                    ...
                    <Text style={{fontSize: 10,textAlign: 'center'}}>Processing Charge Collection Account</Text>
                    </View>
                </View>
                                    ...
                                    rows.map((item,index)=>{
                                        ...
                                        return (
                                            <View style={styles.TableRow}>
                                                ...
                                                <View style={styles.TableColumnLg}><Text>Processing Charge Collection from {item.ac_no}</Text></View>
