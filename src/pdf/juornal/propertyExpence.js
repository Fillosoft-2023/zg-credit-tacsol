        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.head}>
                    ...
                    <Text style={{fontSize: 10,textAlign: 'center'}}>Property Expense Account</Text>
                    </View>
                </View>
                        ...
                        <View style={styles.container}>
                           <View style={styles.Table}>
                                <View style={styles.TableRow}>
                                    ...
                                    <View style={styles.TableColumn}><Text>Expence Type</Text></View>
                                    <View style={styles.TableColumn}><Text>Details</Text></View>
                                    <View style={styles.TableColumn}><Text>Type</Text></View>
                                    <View style={styles.TableColumn}><Text>Amount</Text></View>
                                    <View style={styles.TableColumn}><Text>Reduced value</Text></View>
                                    ...
                                    rows.map((item,index)=>{
                                        ...
                                        return (
                                            <View style={styles.TableRow}>
                                                ...
                                                <View style={styles.TableColumn}><Text>{item.type}</Text></View>
                                                <View style={styles.TableColumn}><Text>{item.detail}</Text></View>
                                                <View style={styles.TableColumn}><Text>Withdrawal</Text></View>
                                                <View style={styles.TableColumn}><Text>{item.amount}</Text></View>
                                                <View style={styles.TableColumn}><Text>{item.red_amount}</Text></View>
