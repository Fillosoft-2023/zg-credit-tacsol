        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.head}>
                    ...
                    <Text style={{fontSize: 10,textAlign: 'center'}}>RD Interest Account</Text>
                    </View>
                </View>
                        ...
                        <View style={styles.container}>
                           <View style={styles.Table}>
                                <View style={styles.TableRow}>
                                    ...
                                    <View style={styles.TableColumnLg}><Text>Details</Text></View>
                                ...
                                {
                                    rows.map((item,index)=>{
                                        sum += Number(item.m_amnt) - Number(item.ttl_amnt)
                                        return (
                                            <View style={styles.TableRow} key={index}>
                                                <View style={styles.TableColumn}><Text>{item.opn_dte}</Text></View>
                                                <View style={styles.TableColumnLg}><Text>RD from {item.ac_no}</Text></View>
                                                <View style={styles.TableColumn}><Text>{Number(item.m_amnt) - Number(item.ttl_amnt)}</Text></View>
                                                <View style={styles.TableColumn}><Text>Withdrwal</Text></View>
