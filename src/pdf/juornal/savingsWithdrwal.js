        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.head}>
                    ...
                    <Text style={{fontSize: 10,textAlign: 'center'}}>Savings Withdrwal Account</Text>
                    </View>
                </View>
                                    ...
                                    rows.map((item,index)=>{
                                        ...
                                        return (
                                            <View>
                                            {
                                                ...
                                                <View style={styles.TableColumnLg}><Text>Savings transaction with  {item.ac_no}</Text></View>
                                                
                                               
                                                
                                                  
                                                        <View style={styles.TableColumn}><Text>{item.with}</Text></View>
