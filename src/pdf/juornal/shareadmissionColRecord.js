        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.head}>
                    ...
                    <Text style={{fontSize: 10,textAlign: 'center'}}>Share Admission Collection Account</Text>
                    </View>
                </View>
                           ...
                           <View style={styles.Table}>
...

                                {
                                    rows.map((item,index)=>{
                                        ...
                                        return (
                                            <View style={styles.TableRow}>
                                                <View style={styles.TableColumn}><Text>{item.opn_dt}</Text></View>
                                                <View style={styles.TableColumnLg}><Text>Share transaction with id {item.id}</Text></View>
                                                <View style={styles.TableColumn}><Text>{item.adm_fee}</Text></View>
