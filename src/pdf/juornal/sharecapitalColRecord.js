        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.head}>
                    ...
                    <Text style={{fontSize: 10,textAlign: 'center'}}>Share Capital Collection Account</Text>
                    </View>
                </View>
                                    ...
                                    rows.map((item,index)=>{
                                        ...
                                        return (
                                            <View style={styles.TableRow}>
                                                ...
                                                <View style={styles.TableColumnLg}><Text>Share transaction with id {item.sh_id}</Text></View>
                                                {
                                                item.dr == 0 ? (
                                                    <View style={styles.TableColumn}><Text>{item.cr}</Text></View>
                                                ) : (
                                                    <View style={styles.TableColumn}><Text>{item.dr}</Text></View>
                                                )
                                            }
                                            {
                                                item.dr == 0 ? (
